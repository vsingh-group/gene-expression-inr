...
def create_vertical_visualization(donor="9861", matter="83"):
    ...
    flow_axes[0].text(-0.15, 1.14, 'a', transform=flow_axes[0].transAxes, 
                      fontsize=24, fontweight='bold', va='top', ha='left')
    
    # Labels for other plots
    ax_eigenvalues.text(-0.08, 1.05, 'b', transform=ax_eigenvalues.transAxes, 
                        fontsize=24, fontweight='bold', va='top', ha='left')
    ax_eigenvectors.text(-0.08, 1.05, 'c', transform=ax_eigenvectors.transAxes, 
                         fontsize=24, fontweight='bold', va='top', ha='left')
