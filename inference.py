...
def load_model(model_path):
    ...
    model = Siren(in_features=5, out_features=1, hidden_features=2048, hidden_layers=5, outermost_linear=True)
...
def inference(id, matter, atlas, model_path, all_records=False, order_val=None):
    ...
    nib.save(new_img, f'./nii_results_full/{matter}_{id}.nii.gz')
...
for i, row in df.iterrows():
    ...
    model_path = f'./models_test/model_se.pth'
