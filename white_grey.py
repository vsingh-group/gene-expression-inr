...
white_matter = nib.load('./data/MNI152_T1_1mm_brain_white.nii.gz')
grey_matter = nib.load('./data/MNI152_T1_1mm_brain_grey.nii.gz')
...
meta_df.to_csv("./data/ClassifiedGeneRegionTable.csv", index=False)
